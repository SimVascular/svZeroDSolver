...
\DoxyCodeLine{32 \textcolor{comment}{ * @brief MODEL namespace documentation source file}}
\DoxyCodeLine{33 \textcolor{comment}{ */}}
\DoxyCodeLine{34 \textcolor{preprocessor}{\#ifndef SVZERODSOLVER\_MODEL\_NAMESPACE\_HPP\_}}
\DoxyCodeLine{35 \textcolor{preprocessor}{\#define SVZERODSOLVER\_MODEL\_NAMESPACE\_HPP\_}}
\DoxyCodeLine{36 \textcolor{comment}{}}
\DoxyCodeLine{37 \textcolor{comment}{/**}}
\DoxyCodeLine{38 \textcolor{comment}{ * @brief MODEL namespace}}
\DoxyCodeLine{39 \textcolor{comment}{ *}}
\DoxyCodeLine{40 \textcolor{comment}{ * The MODEL namespace contains all classes that are used to build a 0D blood}}
\DoxyCodeLine{41 \textcolor{comment}{ * flow model, including the components (elements) of the model themselves and}}
\DoxyCodeLine{42 \textcolor{comment}{ * a few auxilliary classes.}}
\DoxyCodeLine{43 \textcolor{comment}{ *}}
\DoxyCodeLine{44 \textcolor{comment}{ */}}
\DoxyCodeLine{45 \textcolor{keyword}{namespace }\mbox{\hyperlink{namespace_m_o_d_e_l}{MODEL}} \{\}  \textcolor{comment}{// namespace MODEL}}
\DoxyCodeLine{46 }
\DoxyCodeLine{47 \textcolor{preprocessor}{\#endif  }\textcolor{comment}{// SVZERODSOLVER\_MODEL\_NAMESPACE\_HPP\_}}
