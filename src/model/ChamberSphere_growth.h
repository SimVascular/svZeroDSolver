...
/**
 * @file ChamberSphere_growth.h
 * @brief model::ChamberSphere_growth source file
 */
#ifndef SVZERODSOLVER_MODEL_ChamberSphere_growth_HPP_
#define SVZERODSOLVER_MODEL_ChamberSphere_growth_HPP_
 ...
 *
 */
class ChamberSphere_growth : public Block {
 public:
  /**
  ...
  /**
   * @brief Construct a new ChamberSphere object with growth properties
   *
   * @param id Global ID of the block
   * @param model The model to which the block belongs
   */
  ChamberSphere_growth(int id, Model* model)
      : Block(id, model, BlockType::chamber_sphere_growth, BlockClass::vessel,
              {{"rho", InputParameter()},
...
#endif  // SVZERODSOLVER_MODEL_ChamberSphere_growth_HPP_
