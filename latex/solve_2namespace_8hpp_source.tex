\hypertarget{solve_2namespace_8hpp_source}{}\doxysection{namespace.\+hpp}
\label{solve_2namespace_8hpp_source}\index{solve/namespace.hpp@{solve/namespace.hpp}}
\mbox{\hyperlink{solve_2namespace_8hpp}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{32 \textcolor{comment}{ * @brief SOLVE namespace documentation source file}}
\DoxyCodeLine{33 \textcolor{comment}{ */}}
\DoxyCodeLine{34 \textcolor{comment}{}}
\DoxyCodeLine{35 \textcolor{comment}{/**}}
\DoxyCodeLine{36 \textcolor{comment}{ * @brief SOLVE namespace}}
\DoxyCodeLine{37 \textcolor{comment}{ *}}
\DoxyCodeLine{38 \textcolor{comment}{ * The SOLVE namespace contains all tools for running 0D simulations.}}
\DoxyCodeLine{39 \textcolor{comment}{ */}}
\DoxyCodeLine{40 \textcolor{keyword}{namespace }\mbox{\hyperlink{namespace_s_o_l_v_e}{SOLVE}} \{\}}
