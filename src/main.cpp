...
int main(int argc, char *argv[])
{
    ...
    if (steady_inital)
    {
        ...
        ALGEBRA::Integrator<T, S> integrator_steady(system, time_step_size_steady, 0.1, 1e-8, max_iter);
    ...
    ALGEBRA::Integrator<T, S> integrator(system, time_step_size, 0.1, 1e-8, max_iter);
