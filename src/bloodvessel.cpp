...
void BloodVessel::update_constant(System &system)
{
    ...
    system.F(global_eqn_ids[1], global_var_ids[3]) = -1.0;

    system.F(global_eqn_ids[2], global_var_ids[0]) = 1.0;
    system.F(global_eqn_ids[2], global_var_ids[1]) = -params.R;
...
void BloodVessel::update_solution(System &system, Eigen::VectorXd &y)
{
    ...
    system.F(global_eqn_ids[2], global_var_ids[1]) = fac2;
    system.dF(global_eqn_ids[0], global_var_ids[1]) = fac1;
    system.dF(global_eqn_ids[2], global_var_ids[1]) = fac1;
}
