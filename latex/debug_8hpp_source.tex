...
\DoxyCodeLine{31 \textcolor{comment}{ * @file debug.hpp}}
\DoxyCodeLine{32 \textcolor{comment}{ * @brief HELPERS::DEBUG source file}}
\DoxyCodeLine{33 \textcolor{comment}{ */}}
\DoxyCodeLine{34 \textcolor{preprocessor}{\#ifndef SVZERODSOLVER\_HELPERS\_DEBUG\_HPP\_}}
\DoxyCodeLine{35 \textcolor{preprocessor}{\#define SVZERODSOLVER\_HELPERS\_DEBUG\_HPP\_}}
\DoxyCodeLine{36 }
\DoxyCodeLine{37 \textcolor{preprocessor}{\#include <iostream>}}
\DoxyCodeLine{38 }
\DoxyCodeLine{39 \textcolor{preprocessor}{\#ifndef DEBUG}}
\DoxyCodeLine{40 \textcolor{preprocessor}{\#define DEBUG\_MSG(str)             \(\backslash\)}}
\DoxyCodeLine{41 \textcolor{preprocessor}{  do \{                             \(\backslash\)}}
\DoxyCodeLine{42 \textcolor{preprocessor}{    std::cout << str << std::endl; \(\backslash\)}}
\DoxyCodeLine{43 \textcolor{preprocessor}{  \} while (false)}}
\DoxyCodeLine{44 \textcolor{preprocessor}{\#else}}
\DoxyCodeLine{45 \textcolor{preprocessor}{\#define DEBUG\_MSG(str) \(\backslash\)}}
\DoxyCodeLine{46 \textcolor{preprocessor}{  do \{                 \(\backslash\)}}
\DoxyCodeLine{47 \textcolor{preprocessor}{  \} while (false)}}
\DoxyCodeLine{48 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{49 }
\DoxyCodeLine{50 \textcolor{preprocessor}{\#endif  }\textcolor{comment}{// SVZERODSOLVER\_HELPERS\_DEBUG\_HPP\_}}
