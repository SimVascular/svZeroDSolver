/**
 * @file rcrblockwithdistalpressure.hpp
 * @brief MODEL::RCRBlockWithDistalPressure source file
 */
...
{
    /**
     * @brief RCR boundary condition element
     *
    ...
    public:
        ...
        /**
         * @brief Construct a new RCRBlockWithDistalPressure object
         *
        ...
        /**
         * @brief Destroy the RCRBlockWithDistalPressure object
         *
         */
