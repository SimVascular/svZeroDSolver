...
\begin{DoxyItemize}
\item \href{https://github.com/StanfordCBCL/svZeroDSolver}{\texttt{ Source repository}}
...
All classes make use of templates to allow easy exchange of scalar types like {\ttfamily double} or {\ttfamily float}.\hypertarget{index_autotoc_md5}{}\doxysection{Build sv\+Zero\+DSolver}\label{index_autotoc_md5}
sv\+Zero\+DSolver uses CMake to build the tool. The dependencies are installed by CMake. If you want to use the C++ Python interface of sv\+Zero\+DSolver make sure to checkout the correct Python environment beforehand. Currently supported are\+:
...
\end{DoxyItemize}\hypertarget{index_autotoc_md6}{}\doxysubsection{Build in debug mode}\label{index_autotoc_md6}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md7}{}\doxysubsection{Build in release mode}\label{index_autotoc_md7}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md8}{}\doxysubsection{Build on Sherlock}\label{index_autotoc_md8}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md9}{}\doxysection{Run sv\+Zero\+DSolver}\label{index_autotoc_md9}
...
{\ttfamily path/to/config.\+json} and {\ttfamily path/to/output.\+csv} should be replaced by the correct paths to the input and output file, respectively.\hypertarget{index_autotoc_md10}{}\doxysubsection{Simulation parameters}\label{index_autotoc_md10}
...
\end{longtabu}
\hypertarget{index_autotoc_md11}{}\doxysection{Developer Guide}\label{index_autotoc_md11}
