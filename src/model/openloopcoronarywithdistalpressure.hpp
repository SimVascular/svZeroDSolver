...
namespace MODEL
{
    ...
    void OpenLoopCoronaryWithDistalPressure<T>::update_constant(ALGEBRA::SparseSystem<T> &system)
    {
        if (issteady)
        {
            ...
            system.F.coeffRef(this->global_eqn_ids[0], this->global_var_ids[0]) = -params.Cim;
            system.F.coeffRef(this->global_eqn_ids[0], this->global_var_ids[1]) = params.Cim * (params.Ra + params.Ram);
            ...
            system.F.coeffRef(this->global_eqn_ids[1], this->global_var_ids[1]) = params.Ra + params.Ram + params.Rv;
        }
        else
        {
            system.F.coeffRef(this->global_eqn_ids[0], this->global_var_ids[1]) = params.Cim * params.Rv;
            system.F.coeffRef(this->global_eqn_ids[0], this->global_var_ids[2]) = -1.0;
            system.F.coeffRef(this->global_eqn_ids[1], this->global_var_ids[0]) = params.Cim * params.Rv;
            system.F.coeffRef(this->global_eqn_ids[1], this->global_var_ids[1]) = -params.Cim * params.Rv * params.Ra;
            system.F.coeffRef(this->global_eqn_ids[1], this->global_var_ids[2]) = -(params.Rv + params.Ram);

            system.E.coeffRef(this->global_eqn_ids[0], this->global_var_ids[0]) = -params.Ca * params.Cim * params.Rv;
            system.E.coeffRef(this->global_eqn_ids[0], this->global_var_ids[1]) = params.Ra * params.Ca * params.Cim * params.Rv;
            system.E.coeffRef(this->global_eqn_ids[0], this->global_var_ids[2]) = -params.Cim * params.Rv;
            system.E.coeffRef(this->global_eqn_ids[1], this->global_var_ids[2]) = -params.Cim * params.Rv * params.Ram;
        }
    }
