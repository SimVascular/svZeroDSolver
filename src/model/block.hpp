...
namespace MODEL
{
    ...
    public:
         ...
         * \f]
         *
         * with \f$P_{in} \f$, \f$Q_{in} \f$, \f$P_{out} \f$, \f$Q_{out} \f$, and \f$V \f$ denoting inlet pressure, inlet
         * flow, outlet pressure, outlet flow and an internal variable of the
