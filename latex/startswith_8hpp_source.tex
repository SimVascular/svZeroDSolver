...
\DoxyCodeLine{31 \textcolor{comment}{ * @file startswith.hpp}}
\DoxyCodeLine{32 \textcolor{comment}{ * @brief HELPERS::startswith source file}}
\DoxyCodeLine{33 \textcolor{comment}{ */}}
\DoxyCodeLine{34 \textcolor{preprocessor}{\#ifndef SVZERODSOLVER\_HELPERS\_STARTSWITH\_HPP\_}}
\DoxyCodeLine{35 \textcolor{preprocessor}{\#define SVZERODSOLVER\_HELPERS\_STARTSWITH\_HPP\_}}
\DoxyCodeLine{36 }
...
\DoxyCodeLine{41 \textcolor{comment}{ * @brief Check if a string starts with the letters of another string}}
\DoxyCodeLine{42 \textcolor{comment}{ *}}
\DoxyCodeLine{43 \textcolor{comment}{ * @param str The string to check for the specified prefix}}
\DoxyCodeLine{44 \textcolor{comment}{ * @param prefix The prefix the string should be checked for}}
\DoxyCodeLine{45 \textcolor{comment}{ * @return true if strings starts with the prefix, otherwise false}}
\DoxyCodeLine{46 \textcolor{comment}{ */}}
\DoxyCodeLine{47 \textcolor{keywordtype}{bool} \mbox{\hyperlink{namespace_h_e_l_p_e_r_s_aa60c2dfbfc096834b6cd243f84b9c47b}{startswith}}(\textcolor{keyword}{const} std::string \&str, \textcolor{keyword}{const} std::string \&prefix) \{}
\DoxyCodeLine{48   \textcolor{keywordflow}{return} str.size() >= prefix.size() \&\&}
\DoxyCodeLine{49          str.compare(0, prefix.size(), prefix) == 0;}
\DoxyCodeLine{50 \}}
\DoxyCodeLine{51 \}  \textcolor{comment}{// namespace HELPERS}}
\DoxyCodeLine{52 }
\DoxyCodeLine{53 \textcolor{preprocessor}{\#endif  }\textcolor{comment}{// SVZERODSOLVER\_HELPERS\_STARTSWITH\_HPP\_}}
