...
/**
 * @file ChamberSphere_expmat.h
 * @brief model::ChamberSphere_expmat source file
 */
#ifndef SVZERODSOLVER_MODEL_ChamberSphere_expmat_HPP_
#define SVZERODSOLVER_MODEL_ChamberSphere_expmat_HPP_
 ...
 *
 */
class ChamberSphere_expmat : public Block {
 public:
  /**
...
#endif  // SVZERODSOLVER_MODEL_ChamberSphere_expmat_HPP_
