...
\DoxyCodeLine{38 }
\DoxyCodeLine{39 \textcolor{preprocessor}{\#ifndef NDEBUG}}
\DoxyCodeLine{40 \textcolor{preprocessor}{\#define DEBUG\_MSG(str)                                   \(\backslash\)}}
\DoxyCodeLine{41 \textcolor{preprocessor}{  do \{                                                   \(\backslash\)}}
\DoxyCodeLine{42 \textcolor{preprocessor}{    std::cout << "{}[DEBUG MESSAGE] "{}} << str << std::endl; \(\backslash\)}
\DoxyCodeLine{43   \} while (false)}
