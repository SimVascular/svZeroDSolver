...
\DoxyCodeLine{sudo apt install python-\/pybind11     \# Python bindings}
...
\end{DoxyCode}
\hypertarget{index_autotoc_md10}{}\doxysubsection{Build on cluster}\label{index_autotoc_md10}
If you want to build without the need for a package manager, use the following instructions
...
\DoxyCodeLine{mkdir Release}
\DoxyCodeLine{cd Release}
\DoxyCodeLine{cmake -\/DCMAKE\_BUILD\_TYPE=Release -\/DCLUSTER=ON ..}
\DoxyCodeLine{cmake -\/-\/build }
