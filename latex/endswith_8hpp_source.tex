...
\DoxyCodeLine{31 \textcolor{comment}{ * @file endswith.hpp}}
\DoxyCodeLine{32 \textcolor{comment}{ * @brief HELPERS::endswith source file}}
\DoxyCodeLine{33 \textcolor{comment}{ */}}
\DoxyCodeLine{34 \textcolor{preprocessor}{\#ifndef SVZERODSOLVER\_HELPERS\_ENDSWITH\_HPP\_}}
\DoxyCodeLine{35 \textcolor{preprocessor}{\#define SVZERODSOLVER\_HELPERS\_ENDSWITH\_HPP\_}}
\DoxyCodeLine{36 }
\DoxyCodeLine{37 \textcolor{preprocessor}{\#include <string>}}
\DoxyCodeLine{38 }
\DoxyCodeLine{39 \textcolor{keyword}{namespace }\mbox{\hyperlink{namespace_h_e_l_p_e_r_s}{HELPERS}} \{\textcolor{comment}{}}
\DoxyCodeLine{40 \textcolor{comment}{/**}}
\DoxyCodeLine{41 \textcolor{comment}{ * @brief Check if a string ends with the letters of another string}}
\DoxyCodeLine{42 \textcolor{comment}{ *}}
\DoxyCodeLine{43 \textcolor{comment}{ * @param str The string to check for the specified suffix}}
\DoxyCodeLine{44 \textcolor{comment}{ * @param suffix The suffix the string should be checked for}}
\DoxyCodeLine{45 \textcolor{comment}{ * @return true if strings ends with the suffix, otherwise false}}
\DoxyCodeLine{46 \textcolor{comment}{ */}}
\DoxyCodeLine{47 \textcolor{keywordtype}{bool} \mbox{\hyperlink{namespace_h_e_l_p_e_r_s_a6ca9cc09c804d2e0bc4e6890b19b6014}{endswith}}(\textcolor{keyword}{const} std::string \&str, \textcolor{keyword}{const} std::string \&suffix) \{}
\DoxyCodeLine{48   \textcolor{keywordflow}{if} (str.length() >= suffix.length()) \{}
\DoxyCodeLine{49     \textcolor{keywordflow}{return} (0 == str.compare(str.length() -\/ suffix.length(), suffix.length(),}
\DoxyCodeLine{50                              suffix));}
\DoxyCodeLine{51   \} \textcolor{keywordflow}{else} \{}
\DoxyCodeLine{52     \textcolor{keywordflow}{return} \textcolor{keyword}{false};}
\DoxyCodeLine{53   \}}
\DoxyCodeLine{54 \}}
\DoxyCodeLine{55 \}  \textcolor{comment}{// namespace HELPERS}}
\DoxyCodeLine{56 }
\DoxyCodeLine{57 \textcolor{preprocessor}{\#endif  }\textcolor{comment}{// SVZERODSOLVER\_HELPERS\_ENDSWITH\_HPP\_}}
