...
void ChamberSphere_growth::update_constant(SparseSystem& system,
  ...
  system.E.coeffRef(global_eqn_ids[0], global_var_ids[5]) =
      pow(Theta_c, 2) * Theta_r * rho * thick0;
...
void ChamberSphere_growth::update_solution(
  ...
  system.C.coeffRef(global_eqn_ids[1]) =
      ...
      (4 * C0 * C1 * (radius + radius0) *
           (2 * pow(Theta_c, 2) * pow(radius + radius0, 6) +
            pow(Theta_r, 2) * pow(radius0, 6) -
            3 * pow(radius0, 2) * pow(radius + radius0, 4) *
                fabs(pow(Theta_c, 1.3333333333333333) *
                     pow(Theta_r, 0.66666666666666663))) *
           (-pow(Theta_c, 2) * pow(Theta_r, 2) * pow(radius0, 6) +
            pow(Theta_c, 2) * pow(Theta_r, 2) * pow(radius + radius0, 6) +
            (pow(Theta_c, 2) - pow(Theta_r, 2)) *
                (0.66666666666666663 * pow(Theta_c, 2) *
                     pow(radius + radius0, 6) +
                 0.33333333333333331 * pow(Theta_r, 2) * pow(radius0, 6))) *
           exp(C1 *
               pow(2 * pow(Theta_c, 2) * pow(radius + radius0, 6) +
                       pow(Theta_r, 2) * pow(radius0, 6) -
                       3 * pow(radius0, 2) * pow(radius + radius0, 4) *
                           fabs(pow(Theta_c, 1.3333333333333333) *
                                pow(Theta_r, 0.66666666666666663)),
               ...
               (pow(radius0, 4) * pow(radius + radius0, 8) *
                pow(fabs(pow(Theta_c, 1.3333333333333333) *
                         pow(Theta_r, 0.66666666666666663)),
                    2))) +
       C2 * C3 * pow(Theta_c, 2) *
           (1.3333333333333333 * pow(Theta_c, 2) +
            0.66666666666666663 * pow(Theta_r, 2)) *
           pow(radius + radius0, 11) *
           (pow(Theta_c, 2) * pow(radius + radius0, 2) -
            pow(radius0, 2) * fabs(pow(Theta_c, 1.3333333333333333) *
                                   pow(Theta_r, 0.66666666666666663))) *
           exp(C3 *
               pow(pow(Theta_c, 2) * pow(radius + radius0, 2) -
                       pow(radius0, 2) *
                           fabs(pow(Theta_c, 1.3333333333333333) *
                                pow(Theta_r, 0.66666666666666663)),
                   2) /
               (pow(radius0, 4) * pow(fabs(pow(Theta_c, 1.3333333333333333) *
                                           pow(Theta_r, 0.66666666666666663)),
                                      2))) +
       pow(Theta_c, 2) * pow(Theta_r, 2) * dradius_dt * eta *
           (pow(Theta_c, 2) * pow(radius + radius0, 12) +
            2 * pow(Theta_r, 2) * pow(radius0, 12)) *
           pow(fabs(pow(Theta_c, 1.3333333333333333) *
                    pow(Theta_r, 0.66666666666666663)),
               2)) /
      (pow(Theta_c, 2) * pow(Theta_r, 2) * pow(radius0, 2) *
       pow(radius + radius0, 11) *
       pow(fabs(pow(Theta_c, 1.3333333333333333) *
                pow(Theta_r, 0.66666666666666663)),
           2));
           ...
           exp(C1 *
               ...
               (pow(radius0, 4) * pow(radius + radius0, 8) *
                pow(fabs(pow(Theta_c, 1.3333333333333333) *
                         pow(Theta_r, 0.66666666666666663)),
                    2))) +
       4 * C2 * pow(C3, 2) * pow(Theta_c, 4) *
           (1.3333333333333333 * pow(Theta_c, 2) +
            0.66666666666666663 * pow(Theta_r, 2)) *
           pow(radius + radius0, 20) *
           pow(pow(Theta_c, 2) * pow(radius + radius0, 2) -
                   pow(radius0, 2) * fabs(pow(Theta_c, 1.3333333333333333) *
                                          pow(Theta_r, 0.66666666666666663)),
               2) *
           exp(C3 *
               ...
               (pow(radius0, 4) * pow(fabs(pow(Theta_c, 1.3333333333333333) *
                                      ...
                                      2))) +
       pow(radius0, 4) * pow(radius + radius0, 8) *
           (4 * C0 * C1 * pow(Theta_c, 2) *
                (4.0 * pow(Theta_c, 2) + 2.0 * pow(Theta_r, 2)) *
                pow(radius + radius0, 6) *
                (2 * pow(Theta_c, 2) * pow(radius + radius0, 6) +
                 pow(Theta_r, 2) * pow(radius0, 6) -
                 3 * pow(radius0, 2) * pow(radius + radius0, 4) *
            ...
            48 * C0 * C1 * pow(radius + radius0, 4) *
                ...
                (-pow(Theta_c, 2) * pow(Theta_r, 2) * pow(radius0, 6) +
                 ...
                 (pow(Theta_c, 2) - pow(Theta_r, 2)) *
                     (0.66666666666666663 * pow(Theta_c, 2) *
                          pow(radius + radius0, 6) +
                      0.33333333333333331 * pow(Theta_r, 2) *
                          pow(radius0, 6))) *
                exp(C1 *
                    pow(2 * pow(Theta_c, 2) * pow(radius + radius0, 6) +
                            pow(Theta_r, 2) * pow(radius0, 6) -
                ...
                exp(C3 *
                    ...
                    (pow(radius0, 4) *
                     pow(fabs(pow(Theta_c, 1.3333333333333333) *
                              pow(Theta_r, 0.66666666666666663)),
                         2))) +
            11 * C2 * C3 * pow(Theta_c, 2) *
                (1.3333333333333333 * pow(Theta_c, 2) +
                 0.66666666666666663 * pow(Theta_r, 2)) *
                pow(radius + radius0, 10) *
                (pow(Theta_c, 2) * pow(radius + radius0, 2) -
                 pow(radius0, 2) * fabs(pow(Theta_c, 1.3333333333333333) *
                                        pow(Theta_r, 0.66666666666666663))) *
                exp(C3 *
                    ...
                    (pow(radius0, 4) *
                     pow(fabs(pow(Theta_c, 1.3333333333333333) *
                              pow(Theta_r, 0.66666666666666663)),
                         2))) +
            12 * pow(Theta_c, 4) * pow(Theta_r, 2) * dradius_dt * eta *
                pow(radius + radius0, 11) *
                pow(fabs(pow(Theta_c, 1.3333333333333333) *
                         pow(Theta_r, 0.66666666666666663)),
                    2)) *
...
void ChamberSphere_growth::compute_active_stress_values(
    std::vector<double>& parameters) {
